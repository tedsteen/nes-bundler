...
use crate::{
    settings::{MAX_PLAYERS}, network::{NetplayState}, GameRunner,
};
            ...
            match &mut netplay.state {
                NetplayState::Disconnected => {
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.add(TextEdit::singleline(&mut netplay.room_name).desired_width(140.0)
                        ...
                        ui.add(egui::DragValue::new(&mut netplay.max_prediction).speed(1.0).clamp_range(1..=20));
                        ui.end_row();
                        ui.label("Input delay (frames)");
                        ui.add(egui::DragValue::new(&mut netplay.input_delay).speed(1.0).clamp_range(1..=7));
                        ui.end_row();
